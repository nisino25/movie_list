        ...
        <div v-if="!(results.poster_path === '')">
          <div v-if="condition !== 'error'">  
            ...
            <ul >
              <li > 
                <div class="reusult">
                  <strong>{{ result.original_title }} </strong><br><br>
                  <div v-if="result.adult">
                    <a v-bind:href="'https://www.themoviedb.org/search?query=' + result.original_title" target="_blank">Check this movie at TMDB</a>&nbsp;&nbsp;
                  </div>
                  
                  <div v-else>
                    <a v-bind:href="'https://www.themoviedb.org/movie/' + result.id" target="_blank">Check this movie at TMDB</a>&nbsp;&nbsp;
                  </div>
