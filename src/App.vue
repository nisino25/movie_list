          ...
          <div v-if="!(results.poster_path === '')">
            <div v-if="condition !== 'error'">  
              ...
              <ul >
                <li > 
                  <div class="reusult">
                    <strong v-if="!(multipleYears)" class="minutes">{{i + 1}}  </strong>&nbsp; &nbsp;<strong v-if="!(multipleYears)">  {{ result.original_title }} <br><br></strong>
                    <strong v-if="multipleYears" class="minutes">{{i-19}}  </strong>&nbsp; &nbsp;<strong v-if="multipleYears">  {{ result.original_title }} <br><br></strong>
